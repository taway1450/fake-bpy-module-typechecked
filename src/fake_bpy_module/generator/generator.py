...
from .helper_module_generator import (
    ensure_stub_internal_reexport,
    generate_overload_mapping_helper,
    has_overload_mapping_usage,
)
from .writers import (
    BaseWriter,
    JsonWriter,
...
def generate(documents: list[nodes.document]) -> None:
    ...
    has_operator_mapping_decorator = has_overload_mapping_usage(documents)
